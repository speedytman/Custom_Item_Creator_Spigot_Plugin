...
public class ToolMaterialMenu {
    private Inventory inventory;

    public void createMenu(Player player) {

        inventory = Bukkit.createInventory(player, 9, ChatColor.BOLD + "Choose Tool Material");
        ...
        woodMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Create Wood Tool");
        wood.setItemMeta(woodMeta);

        ItemMeta stoneMeta = stone.getItemMeta();
        stoneMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Create Stone Tool");
        stone.setItemMeta(stoneMeta);

        ItemMeta ironMeta = iron.getItemMeta();
        ironMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Create Iron Tool");
        iron.setItemMeta(ironMeta);

        ItemMeta goldMeta = gold.getItemMeta();
        goldMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Create Gold Tool");
